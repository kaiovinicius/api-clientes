...
namespace api_clientes.repository.DbClientes
{
    public class RepositoryBaseClientes<TEntity> : IRepositoryBaseDbClientes<TEntity>, IDisposable where TEntity : class
    {
        #region Construtor
        private readonly ClientesContext context;

        public RepositoryBaseClientes(ClientesContext context)
        {
